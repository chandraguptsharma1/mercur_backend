...
module.exports = defineConfig({
  ...
  modules: [
...

    {
      ...
      options: {
        // This is crucial. It sets the fallback provider ID.
        default_provider: "@mercurjs/stripe-tax-provider",
        providers: [
          {
            resolve: "@mercurjs/stripe-tax-provider",
            // The ID used in the database should match this.
